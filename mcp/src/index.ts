...
const API_BASE =
  process.env.KLEINANZEIGEN_API_URL ?? "http://192.168.2.100:80";
...
const server = new McpServer(
  { name: "kleinanzeigen", version: "1.0.0" },
  {
...
server.registerTool(
  ...
  async (args) => {
    ...
    if (args.page_count !== undefined) params.page_count = String(args.page_count);
